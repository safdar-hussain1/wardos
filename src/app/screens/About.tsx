...
const CLAIMS: { id: string; claim: string; enforcedBy: string; testedBy: string }[] = [
  ...
  },
  {
    ...
    testedBy: 'Property tests over thousands of operations assert no drift, and a deposit, charge or staff base pay of 1.5, −100 or NaN paise must be rejected before anything is written',
  },
  {
    id: 'C5',
